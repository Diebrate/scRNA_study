...
for n_i=1:2
    ...
    for nu_i=1:2
        ...
        for eta_i=1:2
            ...
            n_type = par_type{n_i};
            nu_type = par_type{nu_i};
            eta_type = par_type{eta_i};

            %%% load data
            strings = {'../data/simulation_data/simulation_id', num2str(m), '_', n_type, '_n_', nu_type, '_nu_', eta_type, '_eta.csv'};
            %strings = {'../data/simulation_data/test_sample_', n_type, '_n_', nu_type, '_nu_', eta_type, '_eta.csv'};
            ...
            for iter=1:Iter
                disp(['m=', num2str(m), ' b=', num2str(iter - 1), ' n=', n_type, ' nu=', nu_type, ' eta=', eta_type]);
            ...
            filename = {'../results/simulation/', n_type, '_n/', nu_type, '_nu_', eta_type, '_eta/test_mn_id', num2str(m), '.mat'};
